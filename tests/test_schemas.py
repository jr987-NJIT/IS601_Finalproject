...
from app.schemas import UserCreate, UserRead, UserProfileUpdate, PasswordChange
...
class TestUserProfileSchemas:
    """Tests for profile update and password change schemas."""
    ...
    def test_user_profile_update_email(self):
        update = UserProfileUpdate(email="new@example.com")
        assert update.email == "new@example.com"

    def test_password_change_valid(self):
        payload = PasswordChange(current_password="oldpassword", new_password="newpassword")
        assert payload.current_password == "oldpassword"
        assert payload.new_password == "newpassword"
